...
export const CATEGORIES: CategoryMeta[] = [
  ...
  },
  {
    ...
    label: "UI Components",
    icon: Boxes,
    gradient: "from-holo-violet to-holo-mint",
    hex: ["#2DD4BF", "#34F5C5"],
  ...
  },
  {
    ...
    label: "E-Commerce",
    icon: ShoppingBag,
    gradient: "from-holo-amber to-holo-magenta",
    hex: ["#FBBF24", "#34D399"],
  ...
  },
  {
    ...
    label: "Mobile Apps",
    icon: Smartphone,
    gradient: "from-holo-magenta to-holo-sky",
    hex: ["#34D399", "#38BDF8"],
  ...
  },
  {
    ...
    icon: Gamepad2,
    gradient: "from-holo-amber to-holo-cyan",
    hex: ["#FBBF24", "#22D3EE"],
